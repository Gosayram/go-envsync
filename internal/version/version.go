// Package version provides version information and build details for go-envsync.
package version
...
func GetFullVersionInfo() string {
	...
	// Main version line
	versionLine := fmt.Sprintf("go-envsync %s", Version)
...
func (bi *BuildInfo) String() string {
	return fmt.Sprintf("go-envsync version %s (%s) built on %s by %s using %s for %s",
		bi.Version, bi.Commit, bi.Date, bi.BuiltBy, bi.GoVersion, bi.Platform)
}

// Short returns a short version string
func (bi *BuildInfo) Short() string {
	return fmt.Sprintf("go-envsync %s", bi.Version)
}

// String returns a formatted version string for backward compatibility
func String() string {
